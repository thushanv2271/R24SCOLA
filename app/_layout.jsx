    ...
    <AuthProvider>
      <View style={{ flex: 1 }}>
        <Stack>
          ...
          <Stack.Screen name="ComputerScience" options={{ headerShown: false }} />
        ...
        <Stack.Screen name="PHealthScience" options={{ headerShown: false }} />
        <Stack.Screen name="MHealthScience" options={{ headerShown: false }} />
        <Stack.Screen name="NaturalScience" options={{ headerShown: false }} />

        <Stack.Screen name="PNaturalScience" options={{ headerShown: false }} />
        <Stack.Screen name="MNaturalScience" options={{ headerShown: false }} />
        ...
        <Stack.Screen name="BachelorsInside" options={{ headerShown: false }} />

    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.headerContainer}>
        <View style={styles.headerRow}>
          ...
          <Image
            source={require("../assets/images/phdMain.png")} // Update this to your PhD logo
            style={styles.logo}
          />
           <TouchableOpacity
...
export default PhDScholarshipApp;